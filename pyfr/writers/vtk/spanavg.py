...
class VTKSpanAvgWriter(BaseVTKWriter):
    ...
    def _load_soln(self, *args, **kwargs):
        ...
        _mesh2d.etypes = ['quad']
        _mesh2d.eidxs = {'quad': np.array([i for i in range(0, mesh2d.shape[1])])}
        _mesh2d.spts = {'quad': mesh2d}
        _mesh2d.spts_curved = {'quad': curved}
        self.mesh = _mesh2d

        self.soln['quad'] = soln2d
        self.soln['quad-parts'] = np.ones((mesh2d.shape[1]))
